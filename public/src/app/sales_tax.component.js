System.register(['angular2/core', './item.service', './sale.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, item_service_1, sale_service_1, router_1;
        ...
        execute: function() {
            SalesTaxComponent = (function () {
                ...
                SalesTaxComponent = __decorate([
                    core_1.Component({
                        selector: "sales-tax",
                        templateUrl: "/src/app/templates/sales_tax.template.html"
                    }), 
                    __metadata('design:paramtypes', [item_service_1.ItemService, sale_service_1.SaleService, router_1.Router])
                ], SalesTaxComponent);
