System.register(['angular2/core', './item.service', './stolen.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, item_service_1, stolen_service_1, router_1;
            ...
            StolenEditComponent = (function () {
                ...
                StolenEditComponent = __decorate([
                    core_1.Component({
                        ...
                        templateUrl: "src/app/templates/stolen_edit.template.html"
                    }), 
                    __metadata('design:paramtypes', [item_service_1.ItemService, stolen_service_1.StolenService, router_1.Router, router_1.RouteParams])
                ], StolenEditComponent);
