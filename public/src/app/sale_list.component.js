System.register(['angular2/core', './sale.service', './item.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, sale_service_1, item_service_1, router_1;
        ...
        execute: function() {
            SaleListComponent = (function () {
                ...
                SaleListComponent = __decorate([
                    core_1.Component({
                        selector: 'sale-list',
                        templateUrl: "/src/app/templates/sale_list.template.html",
                        styleUrls: ['./css/sale_list.css']
                    }), 
                    __metadata('design:paramtypes', [sale_service_1.SaleService, item_service_1.ItemService, router_1.Router])
                ], SaleListComponent);
